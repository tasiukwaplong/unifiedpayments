<div class="payment d-flex flex-column gap-5 col-9">
    <div class="container">
        <div class="row text-center p-2">
            <a href="<?php echo esc_url( add_query_arg( 'p', 'manage-feesdues' ) );?>" class="btn col border">
                Pending review
            </a>
            <a href="<?php echo esc_url( add_query_arg( 'p', 'manage-feesdues2' ) );?>" class="btn col  border-top border p-2 bg-warning">
                    Active
            </a>
        </div>
    </div>
    ...
    <?php if(isset($_GET['id'])): ?>
        <a href="/administrator-dashboard/?p=manage-feesdues2" class="btn btn-block btn-primary">&lt;&lt; Go back</a>
        <?php
                    ...
                    <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/administrator-dashboard/?p=manage-feesdues2&id=<?php print_r($fd->id);?>" class="btn btn-primary">View</a>
                                </td>
                            </tr>
    ...
    $.ajax(endpoint, {
        ...
        success: function(res){
            ...
            if(res.success === true){
                ...
                setTimeout(function() {
                    window.location = '/administrator-dashboard/?p=manage-feesdues2'
                }, 6500);
...
function deleteFeeDue(id){
    ...
    if(resp === true){
        window.location = '/administrator-dashboard/?p=manage-feesdues2&id='+id+'&delrec='+id
    }
}
</script>